...
public class BoardService {
    ...
    /**
     * 게시물 작성 로직
     * @param boardDto 정해진 양식(title, content, writer)를 입력 값으로 받아야 함
     * @return 생성된 게시물의 고유 id값
     **/
    @Transactional
    ...
    /**
     * 특정 게시물 조회 로직
     * @param id 찾고자 하는 게시물의 고유 id
     * @return 찾은 게시물(title, content, writer)
     **/
    @Transactional(readOnly = true)
     ...
     * @param boardUpdateRequestDto 수정하고자 하는 내용(title, content)
     * @return 변경된 게시물 (title, content)
     **/
    @Transactional
